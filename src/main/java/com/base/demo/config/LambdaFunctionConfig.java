...
public class LambdaFunctionConfig {
    ...
    /**
     * Este Bean é a nossa Função Lambda.
     * O Spring Cloud Function irá expô-lo para a AWS.
     * Usamos Function<Object, String> porque a Lambda será acionada pelo CloudWatch (sem input útil)
